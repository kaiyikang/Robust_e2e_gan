...
class fake_opt():
    def __init__(self):
        self.feat_type = 'kkaldi_what'
        self.delta_order         = 1
        self.left_context_width  = 1
        self.right_context_width = 1
        self.normalize_type = 1
        self.num_utt_cmvn   = 1
        self.model_unit = 'char'
        self.exp_path = 'playground'

path1 = r'/home/kang/Develop/Robust_e2e_gan/k2k/data/clean_aishell/train'
path2 = r'path2'
opt = fake_opt()
train_dataset = SequentialDataset(opt,path1,path2) 