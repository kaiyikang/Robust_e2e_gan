...
root_path = os.path.join(os.path.abspath("."), "data")  # 表示当前所处的文件夹的绝对路径
# 负责生成noise信号的函数
...
def main():
    ...
    clean_wav_list = []
    clean_wav_scp = os.path.join(data_dir, "clean_aishell/train/wav.scp")  # 在data_dir 目录下，有一个clean_wav.scp 文件
